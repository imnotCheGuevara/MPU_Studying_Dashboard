...
GitHub release draft id `388566826` is named `Campus Dashboard Windows Preview 3`, reserves tag `v0.1.0-windows-preview.3`, targets documentation commit `986a2d210d3bf4e51dda988d197adb8bc6c0131f` so the tagged source includes the Chinese friend guide, and remains `draft: true`, `prerelease: true`, with no publication timestamp. Its release notes pin the binary provenance to functional commit `d43707a76c9125587e428004deb2e3110b7b99b0` and run `34806098324`. Its uploaded assets are:
